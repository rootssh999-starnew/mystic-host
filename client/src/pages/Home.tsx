...
function StartupView({ onAction, serverName, startup, onSave }: { onAction: (action: string) => void; serverName: string; startup: string; onSave: (startup: string) => void }) {
...
export default function Home() {
  ...
  const renderPanel = () => {
    ...
    if (activePanel === "Startup") return <StartupView {...props} serverName={activeServer.name} startup="node server.js" onSave={(startup) => settingsMutation.mutate({ name: activeServer.name, startup })} />;
